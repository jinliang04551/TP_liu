...
#import "UIButton+MISImagePosition.h"

@implementation UIButton (MISImagePosition)
...
- (void)MIS_imagePositionStyle:(MISImagePositionStyle)imagePositionStyle spacing:(CGFloat)spacing {
    if (imagePositionStyle == MISImagePositionStyleDefault) {
    ...
    } else if (imagePositionStyle == MISImagePositionStyleRight) {
    ...
    } else if (imagePositionStyle == MISImagePositionStyleTop) {
    ...
    } else if (imagePositionStyle == MISImagePositionStyleBottom) {
        CGFloat imageW = self.imageView.frame.size.width;
        CGFloat imageH = self.imageView.frame.size.height;
        CGFloat titleIntrinsicContentSizeW = self.titleLabel.intrinsicContentSize.width;
        CGFloat titleIntrinsicContentSizeH = self.titleLabel.intrinsicContentSize.height;
